...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let coloredAppearance = UINavigationBarAppearance()
            ...
            coloredAppearance.titleTextAttributes = [.foregroundColor: UIColor(named: "NavigationTitleColor"), .font: UIFont(name: "Khmer Sangam MN", size: 20)]
            coloredAppearance.largeTitleTextAttributes = [.foregroundColor: UIColor(named: "NavigationTitleColor"), .font: UIFont(name: "Khmer Sangam MN", size: 20)]
